  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
        ...
        >
          {/* Logo/Brand Name */}
          <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-cream tracking-wider mb-4">
            FARMS FRESH
          </h1>
          <p className="text-cream/80 text-base sm:text-lg md:text-xl tracking-[0.3em] uppercase font-light">
            Events, Catering & Corporate Kitchen Services
          </p>
        </motion.div>
        ...
        >
          <Link to="/order">
            <Button
              variant="outline"
              size="lg"
              className="px-12 py-6 text-base tracking-widest uppercase border-cream/50 text-cream bg-transparent hover:bg-cream/10 hover:border-cream transition-all duration-500"
            >
              Enter
            </Button>
          </Link>
