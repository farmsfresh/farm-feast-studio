...
const productFeatures = [{
  icon: Globe,
  text: "Diverse global cuisines celebrating today's workforce"
}, {
  icon: Utensils,
  text: "Accommodating to every dietary preference and need"
}, {
  icon: ShieldCheck,
  text: "Unwavering commitment to food safety"
}, {
  icon: Heart,
  text: "Every guest feels considered and cared for"
}];
const About = () => {
  return <Layout>
      <Helmet>
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-forest to-forest-dark">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          duration: 0.6
            ...
            <p className="text-cream/70 text-base md:text-lg leading-relaxed px-4">For many years we've been producing exceptional events and crafting extraordinary culinary experiences that celebrate the bounty of local farms and recipes from our family's homestyle cooking. We use olive oil, farm fresh ingredients and organic wherever possible </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          once: true
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {productFeatures.map((feature, index) => <motion.div key={feature.text} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
